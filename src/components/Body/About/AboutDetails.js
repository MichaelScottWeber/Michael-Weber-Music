			...
			{props => (
				...
				>
					<div className="about-details-container">
						<p>
							Michael Weber is an award winning composer, producer, performer
							and teacher from the Chicago, Illinois area. Specializing in
							writing and producing music for media, his work has been used all
							over the world by such companies as Fox Sports, CBS, A&E, MTV,
							State Farm and others.
						</p>
						<p>
							Although most adept at drums and guitar, Michael uses a wide
							variety of instruments in his recordings, such as ukuleles, hand
